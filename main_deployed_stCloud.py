...
class Analysis():
    ...
    def rolling_reg_ui(self, 
        ...
        # # Manually configure widths for a few columns
        # gb.configure_column("Filename", width=400)
        # gb.configure_column("Slope (umol/L)", width=400)
        # gb.configure_column("Slope Stderr", width=150)
        # gb.configure_column("R2", width=100)
        # gb.configure_column("Slope pval")
        # gb.configure_column("Slope 95% CI")
        # gb.configure_column("SSR", width=75)
        # gb.configure_column("intercept", width=100)
        
        # gb.configure_column("NW Slope (umol/L)", width=150)
        # gb.configure_column("NW Slope Stderr", width=150)
        # gb.configure_column("NW pval", width=80)
        # gb.configure_column("NW Slope 95% CI", width=150)
        # gb.configure_column("Lag", width=75)
