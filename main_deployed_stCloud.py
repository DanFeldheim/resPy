...
class Analysis():
    ...
    def agtable(self, 
        ...
        cell_style_jscode = JsCode("""
                                    function(params) {
                                        ...
                                        //if(params.value != null && params.colDef.field == 'SSR' && params.value > 1000) {
                                            //return {'backgroundColor':'yellow', 'color':'black'};
                                        //}
                                        //if(params.value != null && params.colDef.field == 'System Lag (Pts)' && params.value > 20) {
                                            //return {'backgroundColor':'yellow', 'color':'black'};
                                        //}
        ...
        highlight_columns = ["R2", "Noise %", "slope % RSE", "Spike Score"]
    ...
    def download_regression(self, all_subset_regs):
        ...
        st.markdown(
                    "<p style='color: Blue; font-size: 24px; margin: 0;'>All Adjusted Regression Results with Corrections for Autocorrelation</p>",
                    unsafe_allow_html=True
                   )
