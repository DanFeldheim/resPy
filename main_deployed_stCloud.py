        ...
        with tab2:    
            ...
            with tab3:    
                ...
                if len(all_subset_regs) > 0:
                    ...
                    kde_analysis_df = plot_data.kde(rolling_reg, slope_col="Raw slope (umol/hr)", tol_sd_mult=1.0)
...
class Analysis():
    ...
    def agtable(self, 
        ...
        highlight_columns = ["R2", "Noise %", "slope % RSE", "Spike Score", "slope 95% CI (umol/hr)"]
        ...
        for filename, channels in final_x_y_valid_dict.items():
            ...
            for channel, xy in channels.items():
                ...
                for i in range(num_windows):
                    ...
                    # Slope is now in umol/hr
                    slope = ols_model.params[1]
                    
                    # Intercept remains in umol
    ...
    def rolling_reg_ui(self, 
        ...
        if isinstance(selected, pd.DataFrame) and not selected.empty:
            ...
            slope, intercept = selected["Raw slope (umol/hr)"][0], selected["intercept"][0]
    ...
    def kde(self, 
        ...
        for (fname, ch), g in df.groupby(["Filename", "Channel"], sort=False):
            ...
            rows.append({
                        ...
                        "Most Common Slope (umol/hr)": mode,
        ...
        summary["Most Common Slope (umol/hr)"] = summary["Most Common Slope (umol/hr)"].apply(
                                                                                                lambda x: round(x, 4)
